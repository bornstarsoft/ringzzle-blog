(function (root, factory) {
  ...
  const LEADERBOARD_SCOPE_LINKS = [
    { label: "Today", href: `${LEADERBOARD_ROUTE}?scope=today` },
    { label: "All-Time", href: `${LEADERBOARD_ROUTE}?scope=alltime` },
  ];
  ...
  class RingzzleScene extends SceneBase {
    ...
    buildStaticUi() {
      ...
      this.rankButton = this.add.text(0, 0, "Rank", this.textStyle(12, "#f6fbff", "850"))
        ...
        .setInteractive({ useHandCursor: true })
        .on("pointerdown", () => this.openLeaderboardPage());
    ...
    buildLeaderboardSubmitDom() {
      ...
      panel.innerHTML = [
        ...
        '<div class="ringzzle-submit-links" aria-label="Leaderboard views">',
        '<a class="ringzzle-submit-scope" href="/leaderboard/?scope=today">Today</a>',
        '<a class="ringzzle-submit-scope" href="/leaderboard/?scope=alltime">All-Time</a>',
        '<a class="ringzzle-submit-link" href="/leaderboard/">View leaderboard</a>',
        "</div>",
      ].join("");
      ...
      this.domLeaderboardLink = panel.querySelector(".ringzzle-submit-link");
    ...
    openLeaderboardPage() {
      if (typeof window === "undefined") return;
      window.location.href = LEADERBOARD_ROUTE;
    }
