(function (root, factory) {
  ...
  const SOUND_CUES = {
    ...
    "color-burst": { name: "color-burst", frequency: 520, endFrequency: 1040, duration: 0.18, gain: 0.062, type: "sine" },
  ...
  class RingzzleScene extends SceneBase {
    ...
    playSoundCue(eventName, options) {
      ...
      try {
        ...
        oscillator.stop(now + spec.duration + 0.015);
        if (typeof document !== "undefined") {
