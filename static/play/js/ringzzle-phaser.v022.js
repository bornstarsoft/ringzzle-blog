(function (root, factory) {
  ...
  class RingzzleScene extends SceneBase {
    ...
    syncLeaderboardSubmitPanel() {
      ...
      const submitTop = Math.round(centerY + (compact ? 34 : 38));
      this.domSubmitPanel.style.left = `${panelLeft + 14}px`;
      this.domSubmitPanel.style.top = `${submitTop}px`;
      this.domSubmitPanel.style.width = `${panelWidth - 28}px`;
      ...
      if (typeof document !== "undefined") {
        ...
        doc.dataset.ringzzleLeaderboardSubmitTop = String(submitTop);
        doc.dataset.ringzzleLeaderboardSubmitLeft = String(panelLeft + 14);
      }
    }
    ...
    renderGameOverPanel() {
      ...
      const height = this.layout.height;
      const panelWidth = Math.min(330, width - 32);
      const panelHeight = this.layout.compact ? 322 : 342;
      ...
      const title = this.add.text(centerX, centerY - (this.layout.compact ? 144 : 154), "Game Over", this.textStyle(25, "#f6fbff", "850", "center"));
      title.setOrigin(0.5, 0);
      const score = this.add.text(
        centerX,
        centerY - (this.layout.compact ? 106 : 112),
      ...
      const detail = this.add.text(
        centerX,
        centerY - (this.layout.compact ? 76 : 78),
      ...
      const restart = this.add.text(centerX, centerY + (this.layout.compact ? 128 : 138), "Restart", this.textStyle(15, "#f6fbff", "850", "center"))
        .setOrigin(0.5, 0)
        .setPadding(18, 10)
        .setBackgroundColor("#173447")
        .setInteractive({ useHandCursor: true })
